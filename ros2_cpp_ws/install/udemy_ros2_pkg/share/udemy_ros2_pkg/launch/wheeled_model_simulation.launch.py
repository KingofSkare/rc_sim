...
simulation_world_file_path = Path(udemy_ros2_pkg_path, "world", "wheeled_model_world.sdf")
...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            ...
            remappings=[("model/vehicle_blue/cmd_vel", "/cmd_vel")], # Remapping topic in terminal
            output="screen"
        ), 
